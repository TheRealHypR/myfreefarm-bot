...
def picknick_starten(driver, building_nr, slots, picknick_produkt):
    for s in range(1, 4):
        ...
        try:
            ...
            print('PICKNICK', str(building_nr), ', SLOT', str(s), ': Fertige Produktion wird geleert!')
            ...
            for feld in range(1, 7):
                ...
                if 'production' in farminfo[str(feld)]:
                    ...
                    if int(remain) <= 0 and int(buildingid) == 1:
                        print('FARM', farm, ', FELD', feld, ': Fertiger Acker wird geerntet!')
                        ...
                        print('FARM', farm, ', FELD', feld, ': Fertige Tiere werden gesammelt!')
                        ...
                        print('FARM', farm, ', FELD', feld, ': Fertige Fabrik wird geleert!')
                        print('jetzt wird gesammelt...')
